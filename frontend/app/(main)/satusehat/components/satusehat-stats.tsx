...
export function SatuSehatStats({ studies }: SatuSehatStatsProps) {
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-2">
            <Card className="bg-transparent border-slate-200 shadow-sm flex flex-col justify-between">
                <CardContent className="p-5 flex-1 flex flex-col justify-between">
                    <div className="flex items-center justify-between mb-2">
                        <div>
                            <p className="text-sm font-medium text-slate-500 mb-1">Total Data</p>
                            <h3 className="text-3xl font-bold text-slate-900">{stats.total}</h3>
                        </div>
                        <div className="p-3 bg-slate-100 rounded-full flex items-center justify-center">
                            <HugeiconsIcon icon={DatabaseIcon} className="size-6 text-slate-600" />
                        </div>
                    </div>
            ...
            <Card className="bg-transparent border-slate-200 shadow-sm flex flex-col justify-between">
                <CardContent className="p-5 flex-1 flex flex-col justify-between">
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            <p className="text-sm font-medium text-slate-500 mb-1">Terkirim</p>
                            <h3 className="text-3xl font-bold text-slate-900">{stats.sent}</h3>
                        </div>
                        <div className="p-3 bg-emerald-50 rounded-full flex items-center justify-center">
                            <HugeiconsIcon icon={SentIcon} className="size-6 text-emerald-600" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-1.5 mt-auto">
                        <div className="flex justify-between items-center text-[11px] text-slate-500 font-medium">
                            <span>Persentase</span>
                            <span className="text-emerald-700 font-bold">{stats.sentPct}%</span>
                        </div>
            ...
            <Card className="bg-transparent border-slate-200 shadow-sm flex flex-col justify-between">
                <CardContent className="p-5 flex-1 flex flex-col justify-between">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="p-3 bg-amber-50 rounded-full flex items-center justify-center">
                            <HugeiconsIcon icon={HourglassIcon} className="size-6 text-amber-600" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-1.5 mt-auto">
                        <div className="flex justify-between items-center text-[11px] text-slate-500 font-medium">
                            <span>Menunggu Antrean</span>
                            <span className="text-amber-700 font-bold">{stats.pendingPct}%</span>
                        </div>
                        <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
            ...
            <Card className="bg-transparent border-slate-200 shadow-sm flex flex-col justify-between">
                <CardContent className="p-5 flex-1 flex flex-col justify-between">
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            <p className="text-sm font-medium text-rose-500 mb-1">Gagal</p>
                            <h3 className="text-3xl font-bold text-rose-600">{stats.failed}</h3>
                        </div>
                        <div className="p-3 bg-rose-50 rounded-full flex items-center justify-center">
                            <HugeiconsIcon icon={Alert01Icon} className="size-6 text-rose-600" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-1.5 mt-auto">
                        <div className="flex justify-between items-center text-[11px] text-slate-500 font-medium">
                            <span>Error Transmisi</span>
                            <span className="text-rose-700 font-bold">{stats.failedPct}%</span>
                        </div>
                        <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
