                ...
                <div className="flex-1 min-w-0 pr-1">
                    <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-bold text-slate-900 dark:text-slate-100 truncate">
                            {isActive ? "Exporting CSV..." : isCompleted ? "Export Finished" : "Export Failed"}
                        </span>
                    ...
                    <p className="text-[10px] font-medium text-slate-500 dark:text-slate-400 line-clamp-1 mb-2.5">
                        {isActive ? `Preparing ${task.totalItems} reports...` : 
                         isCompleted ? `Your export is ready for download.` : 
                    ...
                    {isCompleted && task.fileUrl && (
                        <Button 
                            variant="outline" 
                            size="sm" 
                            className="w-full mt-1 h-8 text-[10px] font-bold gap-2"
