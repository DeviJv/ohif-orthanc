    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Enter your credentials to access Quantum PACS
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <FieldDescription className="px-6 text-center text-[10px] text-muted-foreground/60">
        By continuing, you agree to our <a href="#" className="underline decoration-muted-foreground/30 underline-offset-2">Terms of Use</a>{" "}
        and <a href="#" className="underline decoration-muted-foreground/30 underline-offset-2">Data Protection Policy</a>.
      </FieldDescription>
    </div>
  )
}
